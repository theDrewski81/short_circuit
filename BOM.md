...
- ~~Mass ceiling breached (Session 04)~~ — **superseded; the ceiling is not breached.** The 1655 g reading predates the rework that followed it in the same session. `mechanical/preview/mass_budget.py` prints the current figure: **1531 g against the 1.6 kg ceiling**, 69 g of headroom, 1578 g at +25 % on the printed items, under the ceiling in both cases. The shells went to a 2.0 mm wall rather than the 1.6 mm this entry proposed, and two double-counted lines (the neck riser and the head nod ears) came out. See the Gate Condition Status section below. The identical paragraph was deleted from `phases/PHASE_00_HARDWARE.md` on 2026-08-23 as stale; this copy was missed and is corrected here (O13, session J5-S18).
